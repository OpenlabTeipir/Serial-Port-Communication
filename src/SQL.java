...
public class SQL {
	...
	/* Constructor */
	public SQL(String dbName, String dbUsername, String dbPass, String dbHost, String dbPort) {
		this.dbName = dbName;
	...
	public boolean dbConnect() {
		...
		try {
			...
			conn = (Connection) DriverManager.getConnection("jdbc:mysql://"+dbHost+":"+dbPort+"/"
