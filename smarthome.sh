...
# 
# Changes from Evaggelos V. Avgerinos

# Java Home
JAVA_HOME=/usr/java/latest

serviceNameLo="smarthome"
serviceName="SmartHome"
serviceUser="appuser"
serviceGroup="user"
applDir="/var/log/$serviceNameLo.log"
maxShutDownTime=500
pidFile="/var/run/$serviceNameLo.pid"
javaCommand="java"
javaExe="$JAVA_HOME/bin/$javaCommand"
javaArgs="-jar $applDir/smarthome.jar"
javaCommandLine="$javaExe $javaArgs"
javaCommandLineKeyword="smarthome.jar"

# Makes the file $1 writable my group $serviceGroup.
